...
import uplusLogo from "@/app/assets/uplus_mutual_partners_logo.jpg";
import heptaLogo from "@/app/assets/heptanalytics_logo.jpg";
import andelaLogo from "@/app/assets/andela_logo.jpg";
        ...
        <div className="collapse collapse-plus bg-base-200 rounded-md">
          ...
          <div className="collapse-content flex flex-col sm:flex-row sm:justify-between gap-4 sm:items-center">
            ...
            <Image
              src={uplusLogo}
              alt="uplus logo"
              className="rounded-badge order-1 sm:order-2"
            />
          </div>
        </div>
        {/* hepta */}
