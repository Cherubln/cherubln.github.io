    ...
    <div className="card card-compact rounded-md  max-w-sm h-80 bg-base-300 shadow-xl group cursor-pointer">
      ...
      <div className="card-body bg-neutral">
        ...
        <div className="card-actions justify-end">
          <p className="flex justify-end items-center gap-1 -translate-y-5 opacity-0 text-semibold group-hover:opacity-100 cursor-pointer group-hover:translate-y-0 transition-all duration-300 hover:text-primary">
